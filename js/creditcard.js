...
([
    ...
    function(module, exports, __webpack_require__) {
        ...
        let _creditCardType = __webpack_require__(2);

        let _creditCardType2 = _interopRequireDefault(_creditCardType);

        function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

        $(document).on('input change', '#input--cc input', function () {
            let ccNum = $(this).val();
            let ccType = (0, _creditCardType2.default)(ccNum);
            ...
            let creditcardType = ccType[0].type;
